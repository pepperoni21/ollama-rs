...
Feel free to check the [Chatbot example](https://github.com/pepperoni21/ollama-rs/blob/0.3.1/ollama-rs/examples/basic_chatbot.rs) that shows how to use the library to create a simple chatbot in less than 50 lines of code. You can also check some [other examples](https://github.com/pepperoni21/ollama-rs/tree/0.3.1/ollama-rs/examples).
...
_Check chat with history examples for [default](https://github.com/pepperoni21/ollama-rs/blob/0.3.1/ollama-rs/examples/chat_with_history.rs) and [stream](https://github.com/pepperoni21/ollama-rs/blob/0.3.1/ollama-rs/examples/chat_with_history_stream.rs)_
